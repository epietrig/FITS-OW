...
do
	...
	do
	    ...
	    ssh wild@192.168.2.$startIp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no "export DISPLAY=:0 && cd /home2/wild/workspace/zvtm_demos/FITS-OW/trunk && java -XX:+DoEscapeAnalysis -XX:+UseConcMarkSweepGC -Djava.net.preferIPv4Stack=true -Djgroups.bind_addr="\"192.168.2.$startIp\"" -Xmx4g -cp $JARS fr.inria.zvtm.cluster.SlaveApp -n WallFITSOW -b $SLAVENUM -wb $BLOCKNB -f -a $*" &
