...
public class Config {
    ...
    // public static LinkedHashMap<JSkyFitsImage.ScaleAlgorithm,Object> SCALES = new LinkedHashMap(4,1);
    // static {
    //     SCALES.put(JSkyFitsImage.ScaleAlgorithm.LINEAR, null);
    //     SCALES.put(JSkyFitsImage.ScaleAlgorithm.LOG, null);
    //     SCALES.put(JSkyFitsImage.ScaleAlgorithm.HIST_EQ, null);
    //     SCALES.put(JSkyFitsImage.ScaleAlgorithm.SQRT, null);
    // };
